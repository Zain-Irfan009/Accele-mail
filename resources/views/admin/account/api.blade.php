...
@section('content')
    ...
    <p style="margin-bottom: 30px"><code style="font-size: 18px;">
        <a target="_blank" href="{{ action("Admin\ApiController@doc") }}">{{ action("Admin\ApiController@doc") }} <span class="material-icons-outlined">
link
</span></a></code></p>
    ...
    <p style="margin-bottom: 30px" class="d-flex align-items-center">
		...
		<button class="btn btn-secondary api-copy-button ml-4"><i class="material-icons-outlined me-2">copy</i>Copy</button>
	</p>
